...
public class JThumbContainer extends JPanel {

	static Logger logger = Logger.getLogger(JThumbContainer.class);
	...
	public JThumbContainer(Path file) {
		this.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1));

		this.image = new JThumbnail(file, 150, 150);
